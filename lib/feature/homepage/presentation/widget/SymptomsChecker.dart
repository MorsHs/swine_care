          ...
          child: RichText(
            text: TextSpan(
              ...
              children: [
                ...
                TextSpan(
                  text:
                  "These symptoms may indicate African Swine Fever (ASF). Early detection is crucial to prevent the spread of the disease.",
                  style: GoogleFonts.poppins(
                    fontSize: 14,
              ...
              children: [
                Expanded(
                  child: Row(
                    children: [
                      Icon(
                        _getIconForQuestion(question), // Add an icon for each symptom
