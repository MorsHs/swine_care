...
class PreventingAfricanSwineFeverPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xff47b97f),
        elevation: 0,
        title: Text(
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        collapsedBackgroundColor:
            isDarkMode ? Colors.grey[700] : const Color(0xFFC8E6C9),
        backgroundColor: isDarkMode ? Colors.grey[800] : Colors.white,
        leading: Icon(
          title == "Understanding ASF"
              ? Icons.info_outline
        ...
        children: [content],
        collapsedIconColor:
            isDarkMode ? Colors.white70 : const Color(0xFF2E7D32),
  ...
  Widget _buildImageCard(
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
              color: isDarkMode ? Colors.black38 : Colors.grey[300]!,
              blurRadius: 8,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            isDarkMode ? Colors.grey[700]! : const Color(0xFFC8E6C9),
            isDarkMode ? Colors.grey[600]! : const Color(0xFFA5D6A7)
          ],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildTipItem(context, Icons.verified,
              "Train staff on ASF risks and biosecurity protocols."),
          _buildTipItem(context, Icons.verified,
              "Use dedicated boots and clothing for pig areas."),
          _buildTipItem(context, Icons.verified,
              "Monitor wild boar activity and report sightings."),
          _buildTipItem(context, Icons.verified,
              "Collaborate with vets for early detection plans."),
          _buildTipItem(context, Icons.verified,
              "Maintain a clean water supply to avoid contamination."),
        ],
      ),
    );
  }
  ...
  void _showQuickTipsDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        backgroundColor:
            isDarkMode ? Colors.grey[800] : const Color(0xFFE8F5E9),
        title: Row(
          children: [
            ...
            Text("Quick ASF Tips",
                style: GoogleFonts.poppins(
                    fontWeight: FontWeight.w600,
                    color:
                        isDarkMode ? Colors.white : const Color(0xFF1B5E20))),
          ],
        ),
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("• Wash hands thoroughly before and after handling pigs.",
                style: GoogleFonts.poppins(
                    fontSize: 16,
                    color: isDarkMode ? Colors.white70 : Colors.black87)),
            Text("• Keep detailed records of pig movements and health.",
                style: GoogleFonts.poppins(
                    fontSize: 16,
                    color: isDarkMode ? Colors.white70 : Colors.black87)),
            Text("• Avoid contact with unknown or stray pigs.",
                style: GoogleFonts.poppins(
                    fontSize: 16,
                    color: isDarkMode ? Colors.white70 : Colors.black87)),
            Text("• Install motion sensors to detect wild boar intrusions.",
                style: GoogleFonts.poppins(
                    fontSize: 16,
                    color: isDarkMode ? Colors.white70 : Colors.black87)),
          ],
          ...
          TextButton(
            ...
            child: Text("Got it!",
                style: GoogleFonts.poppins(
                    fontSize: 16,
                    color:
                        isDarkMode ? Colors.white : const Color(0xFF388E3C))),
          ),
        ],
      ),
    );
